...
// Shellcode para MessageBox (64 bits) - CORREGIDO
...
int main() {
    ...
    // Modificar el shellcode con las direcciones reales de las funciones
    memcpy(shellcode + 0x2A, &pMessageBoxA, sizeof(void*)); // Dirección de MessageBoxA
    memcpy(shellcode + 0x37, &pExitThread, sizeof(void*));   // Dirección de ExitThread
